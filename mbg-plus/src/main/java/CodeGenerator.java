...
//        completeGenerator();
    ...
    protected static void simpleGenerator() {
        Props pro = PropsUtil.get("generator.properties");
        String path = pro.getStr("generator.path");
        // 包路径
        String packagePath = PROJECT_ROOT_PATH +path+ "/src/main/java";
        // XML文件的路径
        String mapperXmlPath = PROJECT_ROOT_PATH +path+ "/src/main/resources/mapper";

        // 开始执行代码生成
        FastAutoGenerator.create(pro.getStr("jdbc.connectionURL"), pro.getStr("jdbc.userId"), pro.getStr("jdbc.password"))
                // 1. 全局配置
                .globalConfig(builder -> builder
                        // 作者名称
                        .author(pro.getStr("generator.author"))
                        // 开启覆盖已生成的文件。注释掉则关闭覆盖。
                        .fileOverride()
                ...
                .packageConfig((scanner, builder) -> builder
                        //  父包名配置
                        .parent(scanner.apply("请输入父包名：例如 com.sxia"))
                        .moduleName(scanner.apply("请输入模块名：例如 order"))
                ...
                //自定义 代码生成的模版 参考  https://github.com/baomidou/mybatis-plus/blob/3.0/mybatis-plus-generator/src/test/resources/templates/dto.java.vm
...
//                })
    ...
    protected static void completeGenerator() {
        ...
        String entityPath = PROJECT_ROOT_PATH + "/project-entity/src/main/java/com/sxia/entity/" + moduleName;
        String mapperPath = PROJECT_ROOT_PATH + "/project-dao/src/main/java/com/sxia/mapper/" + moduleName;
        String mapperXmlPath = PROJECT_ROOT_PATH + "/project-dao/src/main/resources/mapper/" + moduleName;
        String servicePath = PROJECT_ROOT_PATH + "/project-service/src/main/java/com/sxia/service/" + moduleName;
        String serviceImplPath = PROJECT_ROOT_PATH + "/project-service/src/main/java/com/sxia/service/" + moduleName + "/impl";
        String controllerPath = PROJECT_ROOT_PATH + "/project-controller/src/main/java/com/sxia/controller/" + moduleName;
        // 关于以上写法的解释：
        ...
        FastAutoGenerator.create(pro.getStr("jdbc.connectionURL"), pro.getStr("jdbc.userId"), pro.getStr("jdbc.password"))
                ...
                .packageConfig((scanner, builder) -> builder
                        ...
                        // 父包名配置
                        .parent(scanner.apply("请输入模块名：例如 order"))
